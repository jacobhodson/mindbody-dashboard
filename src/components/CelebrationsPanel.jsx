...
function DaysChip({ days }) {
  ...
  return <span className="rounded-full bg-gray-300/60 px-2 py-0.5 text-xs text-gray-600">{days}d</span>;
}

function ClientRow({ c, sub }) {
  return (
    <div className="flex items-center justify-between px-5 py-2.5 border-b border-gray-200/50 last:border-0 hover:bg-gray-200/30 transition-colors">
...
function EmptyState({ message }) {
  return (
    <div className="py-8 text-center">
      <CheckCircle className="h-6 w-6 text-gray-300 mx-auto mb-2" />
      ...
      <div className="overflow-y-auto max-h-72 scrollbar-thin">
        ...
        {!loading && !error && tab === 'inactive' && (
          birthdaysInactive.length === 0
            ...
            : <>
                <p className="px-5 py-2.5 text-xs text-orange-600/70 bg-orange-500/5 border-b border-gray-200/50">
